...
Simple ios Application that has list of places, with detailed view and a picture.
...
## In the First milestone of asssignment 2 I learnt:
- how to create core data model
- how to use persistence to request and fetch results
- how to add images from url to app 
- how to save data
